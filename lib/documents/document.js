...
export class Document extends BasePermissionedDocument {
  ...
  // rebasedCount: count of how many times this document has been rebased;
  ...
  //               only reason we are currently changing existing steps is to rebase
  ...
  static _limitQuery(query, permissions, user) {
    ...
    // and has not been merged into its own parent document.
