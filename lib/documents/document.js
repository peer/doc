...
export class Document extends BasePermissionedDocument {
  ...
  // publishedAtVersion: version at which this document was published
  ...
  // mergeAcceptedAtVersion: version at which this document was merged into the parent document
  ...
  static PUBLISH_FIELDS() {
    return _.extend(super.PUBLISH_FIELDS(), {
      ...
      publishedAt: 1,
      publishedBy: 1,
      publishedAtVersion: 1,
      mergeAcceptedAt: 1,
      mergeAcceptedBy: 1,
      mergeAcceptedAtVersion: 1,
      title: 1,
      contentKey: 1,
      forkedFrom: 1,
      forkedAtVersion: 1,
