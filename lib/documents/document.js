...
Document.getRolePermissions = (role) => {
  ...
  switch (role) {
    case Document.ROLES.ADMIN:
      permissions = [Document.PERMISSIONS.VIEW, Document.PERMISSIONS.UPDATE, Document.PERMISSIONS.ADMIN,
        Document.PERMISSIONS.PRIVATE_COMMENT_VIEW, Document.PERMISSIONS.PRIVATE_COMMENT_CREATE, Document.PERMISSIONS.COMMENT_VIEW, Document.PERMISSIONS.COMMENT_CREATE];
      break;
    case Document.ROLES.EDIT:
      permissions = [Document.PERMISSIONS.VIEW, Document.PERMISSIONS.UPDATE,
        Document.PERMISSIONS.PRIVATE_COMMENT_VIEW, Document.PERMISSIONS.PRIVATE_COMMENT_CREATE, Document.PERMISSIONS.COMMENT_VIEW, Document.PERMISSIONS.COMMENT_CREATE];
      break;
    case Document.ROLES.VIEW:
      permissions = [Document.PERMISSIONS.VIEW, Document.PERMISSIONS.COMMENT_VIEW];
      break;
    default:
      permissions = [];
      break;
...
Document.getRoleByPermissions = (permissions) => {
  ...
  role = role || Document.ROLES.CUSTOM;
