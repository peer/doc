...
export class Document extends BasePermissionedDocument {
  ...
  // forkedFrom: reference to original document
  // forkedAtVersion: version where the document was forked
...
Document.fork = function fork(...args) {
  args.unshift('Document.fork');
  return Meteor.call(...args);
};

Document.rebaseStep = function rebaseStep(...args) {
  args.unshift('Document.rebaseStep');
  return Meteor.call(...args);
};

Document.merge = function merge(...args) {
  args.unshift('Document.merge');
  return Meteor.call(...args);
};

Document.undoChanges = function undoChanges(...args) {
  args.unshift('Document.undoChanges');
  return Meteor.call(...args);
};
