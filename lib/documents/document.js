  ...
  switch (role) {
    case Document.ROLES.ADMIN:
      permissions = [Document.PERMISSIONS.SEE, Document.PERMISSIONS.UPDATE, Document.PERMISSIONS.ADMIN,
        Document.PERMISSIONS.PRIVATE_COMMENT_SEE, Document.PERMISSIONS.PRIVATE_COMMENT_CREATE, Document.PERMISSIONS.COMMENT_SEE, Document.PERMISSIONS.COMMENT_CREATE];
      break;
    ...
    case Document.ROLES.SEE:
      permissions = [Document.PERMISSIONS.SEE, Document.PERMISSIONS.COMMENT_SEE];
      break;
    default:
      permissions = [];
      break;
...
Document.checkDocumentPermissions = function checkDocumentPermissions(...args) {
  args.unshift('Document.checkDocumentPermissions');
  return Meteor.call(...args);
};
