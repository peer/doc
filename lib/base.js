...
// This static method is defined like this to work around an import cycle between "User" and "BaseDocument".
// eslint-disable-next-line func-names
(function () {
  // eslint-disable-next-line
  import {User} from '/lib/documents/user';

  BaseDocument.prototype.canUser = function canUser(permissions, user) {
    if (!permissions) {
      return false;
    }
  ...
  BaseDocument.restrictQuery = function restrictQuery(query, permissions, user) {
    if (!permissions) {
